                ...
                <v-form @submit.prevent="edit">
                  <v-card-text>
                    ...
                    <v-table class="mx-lg-auto">
                      ...
                      />
                      <v-text-field v-model="dataSend.password" type="password" label="Slaptažodis" :error-messages="errors.password"></v-text-field>
                      <v-text-field v-model="dataSend.password_confirmation" type="password" label="Pakrtokite slaptažodį"></v-text-field>
                    </v-table>
                  </v-card-text>
                  <v-btn block outlined :loading="data.loading" type="submit" class="flex-grow-1" variant="tonal"> Atnaujinti duomenis </v-btn>
                </v-form>
              </v-sheet>
            </v-col>
          </v-row>
